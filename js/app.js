...
function checkGuess() {
    ...
    if (guessCharacter.height == "unknown") {
        ...
        heightContent = document.createTextNode(guessCounter + ". " + guessCharacter.height + "cm")
    }
    ...
    if (guessCharacter.mass == "unknown") {
        ...
        massContent = document.createTextNode(guessCounter + ". " + guessCharacter.mass + "kg")
    }
    ...
    if (guessCharacter.name == mysteryCharacter.name) {
        ...
        if (guessCounter != 8) {
            ...
            playAgainBtn.addEventListener("click", function() {
                ...
                resetUI()
                guessCounter = 0
                return randomNumber = Math.floor((Math.random() * 83) + 1)
            })
            shareScoreBtn.addEventListener("click", function() {
